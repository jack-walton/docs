...
<Image
    src="/images/AXS/navigate_app/navigate_app_main_annotated.jpg"
    width={400}
    height={400}
...
<Image
    src="/images/AXS/navigate_app/navigate_app_profile_1.jpg"
    width={400}
    height={400}
    alt="The top of the profile screen"
/>
...
<Image
    src="/images/AXS/navigate_app/navigate_app_profile_2.jpg"
    width={400}
    height={400}
    alt="The Settings section of the profile screen"
/>
...
<Image
    src="/images/AXS/navigate_app/navigate_app_profile_3.jpg"
    width={400}
    height={400}
...
The **Search** screen allows you to learn more about the AXS events in your area. Directly below the **Profile** button is a search bar and your home location. See [Search for an Event](/search-for-events) for more information about how to use the search bar. You can select the home location to view the events in a different area.

<Image
    src="/images/AXS/navigate_app/home_location.jpg"
    width={400}
    height={400}
    alt="The Home Location screen"
/>
...
<Image
    src="/images/AXS/navigate_app/recently_viewed_events.jpg"
    width={400}
    height={400}
    alt="The Recently Viewed and Explore Event Genres sections"
/>
...
<Image
    src="/images/AXS/navigate_app/discover_events.jpg"
    width={400}
    height={400}
    alt="The Discover Events section"
/>
...
<Image
    src="/images/AXS/navigate_app/your_events.jpg"
    width={400}
    height={400}
    alt="The Your Events screen"
/>
...
<Image
    src="/images/AXS/navigate_app/ticket_resale_1.jpg"
    width={400}
    height={400}
    alt="The ticket resale screen"
/>
...
<Image
    src="/images/AXS/navigate_app/ticket_resale_2.jpg"
    width={400}
    height={400}
    alt="The listings options"
/>
