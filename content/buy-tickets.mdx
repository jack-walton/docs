...
1. Select either **Tickets** or, if available, **AXS Official Resale** to buy tickets from another user.
    ![Step 2](/images/AXS/buy_tickets/buy_tickets_step_2.jpg)
1. Select the number of tickets that you want. Then, tap **Continue**.
    ![Step 3](/images/AXS/buy_tickets/buy_tickets_step_3.jpg)
1. Select a method of delivery, then tap **Continue**.
...
1. Optionally, select the checkbox to save this payment method for future purchases.
...
1. Indicate whether you want to protect your purchase.
1. Review your order information, the **Terms of Use**, and so on.
    ![Step 10](/images/AXS/buy_tickets/buy_tickets_step_10.jpg)
1. If you agree to the terms, select the checkbox and tap **Confirm Purchase**.
