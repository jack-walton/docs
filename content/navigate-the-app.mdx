...
![An annotated picture of the app navigation](/images/AXS/navigate_app/navigate_app_main_annotated.jpg)
...
The **Search** screen allows you to learn more about the AXS events in your area. Directly below the **Profile** button is a search bar and your home location. See [Search for an Event](/images/AXS/search_for_event) for more information about how to use the search bar. You can select the home location to view the events in a different area.
